...
(async function () {
    ...
    let [postCounts, posts] = await Promise.all([await fetch("https://raw.githubusercontent.com/redspacecat/scratch-forums-data/main/post_counts.txt"), await fetch(`/api/topic/${topic}?page=${page}`)]);
    ...
    <div class="container">
        ...
        newEl.querySelector(".post-count").innerText = "~" + parseInt(postCounts[post.author.username] || 1) + " posts";
